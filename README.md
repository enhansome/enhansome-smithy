...
* [Mill Plugin](https://disneystreaming.github.io/smithy4s/docs/overview/installation/#mill) - Community supported plugin that integrates smithy with the [Mill build tool](https://github.com/com-lihaoyi/mill) ⭐ 2,788 | 🐛 271 | 🌐 Scala | 📅 2026-09-01.
...
* [C#](https://github.com/thomaslaich/smithy-dotnet) ⭐ 12 | 🐛 6 | 🌐 C# | 📅 2026-09-05 - Community plugin for generation of clients/servers in C#.
...
* [Tree Sitter Grammar for Smithy](https://github.com/indoorvivants/tree-sitter-smithy) ⭐ 22 | 🐛 5 | 🌐 JavaScript | 📅 2025-05-13 - Tree-sitter grammar for Smithy. Included in [Neovim](https://github.com/nvim-treesitter/nvim-treesitter) ⭐ 14,375 | 🐛 270 | 🌐 Tree-sitter Query | 📅 2026-09-05 and [Helix](https://docs.helix-editor.com/) by default.
