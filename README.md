...
the [Smithy IDL](https://github.com/awslabs/smithy) ⭐ 2,361 | 🐛 89 | 🌐 Java | 📅 2026-09-21.
...
* [Mill Plugin](https://disneystreaming.github.io/smithy4s/docs/overview/installation/#mill) - Community supported plugin that integrates smithy with the [Mill build tool](https://github.com/com-lihaoyi/mill) ⭐ 2,795 | 🐛 278 | 🌐 Scala | 📅 2026-09-21.
* [Smithy CLI](https://github.com/smithy-lang/smithy/tree/main/smithy-cli) ⭐ 2,361 | 🐛 89 | 🌐 Java | 📅 2026-09-21 <img src="/assets/smithy-anvil.svg" alt="(official)" title="Smithy Official" height="10px"> - Smithy CLI is used to build, validate, diff, and transform Smithy models.
...
* [Rust](https://github.com/awslabs/smithy-rs) ⭐ 687 | 🐛 406 | 🌐 Rust | 📅 2026-09-21 <img src="/assets/smithy-anvil.svg" alt="(official)" title="Smithy Official" height="10px"> 🚧 - Client code generation for Rust.
...
* [TypeScript](https://github.com/awslabs/smithy-typescript) ⭐ 327 | 🐛 95 | 🌐 TypeScript | 📅 2026-09-21 <img src="/assets/smithy-anvil.svg" alt="(official)" title="Smithy Official" height="10px"> 🚧 - Client code generation for Typescript.
...
* [Kotlin](https://github.com/awslabs/smithy-kotlin) ⭐ 111 | 🐛 41 | 🌐 Kotlin | 📅 2026-09-21 <img src="/assets/smithy-anvil.svg" alt="(official)" title="Smithy Official" height="10px"> - Client code generation for Kotlin.
* [Python](https://github.com/smithy-lang/smithy-python) ⭐ 85 | 🐛 29 | 🌐 Python | 📅 2026-09-21 <img src="/assets/smithy-anvil.svg" alt="(official)" title="Smithy Official" height="10px"> 🚧 - Client code generation for Python.
...
* [Swift](https://github.com/awslabs/smithy-swift) ⭐ 39 | 🐛 9 | 🌐 Smithy | 📅 2026-09-18 <img src="/assets/smithy-anvil.svg" alt="(official)" title="Smithy Official" height="10px"> 🚧 - Client code generation for Swift.
...
* [C#](https://github.com/thomaslaich/smithy-dotnet) ⭐ 12 | 🐛 4 | 🌐 C# | 📅 2026-09-21 - Community plugin for generation of clients/servers in C#.
* [Erlang, Elixir, Gleam](https://github.com/f34nk/smithy-beam) ⭐ 3 | 🐛 0 | 🌐 Java | 📅 2026-09-21 - Community plugin for generating clients and servers targeting BEAM languages: Erlang, Elixir, Gleam

### Server Code Generators

* [Rust](https://github.com/awslabs/smithy-rs) ⭐ 687 | 🐛 406 | 🌐 Rust | 📅 2026-09-21 <img src="/assets/smithy-anvil.svg" alt="(official)" title="Smithy Official" height="10px"> 🚧 - Server generator for Rust.
* [Scala](https://github.com/disneystreaming/smithy4s) ⭐ 401 | 🐛 116 | 🌐 Scala | 📅 2026-09-10 - Community plugin for generation of clients/servers in Scala.
* [TypeScript](https://github.com/awslabs/smithy-typescript) ⭐ 327 | 🐛 95 | 🌐 TypeScript | 📅 2026-09-21 <img src="/assets/smithy-anvil.svg" alt="(official)" title="Smithy Official" height="10px"> 🚧 - Server generator for TypeScript.
...
* [Rust server SDK examples](https://github.com/awslabs/smithy-rs/tree/main/examples) ⭐ 687 | 🐛 406 | 🌐 Rust | 📅 2026-09-21 <img src="/assets/smithy-anvil.svg" alt="(official)" title="Smithy Official" height="10px"> - a collection of examples using Smithy to generate a Rust server SDK.
...
* [Tree Sitter Grammar for Smithy](https://github.com/indoorvivants/tree-sitter-smithy) ⭐ 22 | 🐛 5 | 🌐 JavaScript | 📅 2025-05-13 - Tree-sitter grammar for Smithy. Included in [Neovim](https://github.com/nvim-treesitter/nvim-treesitter) ⭐ 14,407 | 🐛 270 | 🌐 Tree-sitter Query | 📅 2026-09-19 and [Helix](https://docs.helix-editor.com/) by default.
...
* [Smithy Reference Implementation](https://github.com/awslabs/smithy) ⭐ 2,361 | 🐛 89 | 🌐 Java | 📅 2026-09-21 <img src="/assets/smithy-anvil.svg" alt="(official)" title="Smithy Official" height="10px"> - Smithy reference implementation in Java
...
* [Smithy to JSONSchema](https://github.com/awslabs/smithy/tree/main/smithy-jsonschema) ⭐ 2,361 | 🐛 89 | 🌐 Java | 📅 2026-09-21 <img src="/assets/smithy-anvil.svg" alt="(official)" title="Smithy Official" height="10px"> - Converts Smithy models to [JSONSchema](https://json-schema.org/).
